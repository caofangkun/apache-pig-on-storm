...
/**
 * The collected group operator is a special operator used when users give the
 * hint 'using "collected"' in a group by clause. It implements a map-side group
 * that collects all records for a given key into a buffer. When it sees a key
 * change it will emit the key and bag for records it had buffered. It will
    ...
    while (true) {
      ...
      if (prevKey == null && outputBag == null) {
        ...
        // case we don't want to pay the penalty all the time.
            ...
            // Additionally, if there is a merge join(on a different
            // key) following POCollectedGroup
