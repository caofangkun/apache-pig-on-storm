...
public class RegexInit implements RegexImpl, Serializable {
  ...
  // Intersection and subtraction ( subtraction cannot be used w/o
  // intersection )
  ...
  /**
   * This function determines the type of pattern we are working with The return
   * value of the function determines the type we are expecting
   * 
   * @param pattern
   * @return int, 0 means this is java.util.regex, 1 means this is
   *         dk.brics.automaton
   */
