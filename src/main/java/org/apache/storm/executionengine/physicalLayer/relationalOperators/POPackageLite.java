...
/**
 * This package operator is a specialization of POPackage operator used for the
 * specific case of the order by query. See JIRA 802 for more details.
 */
public class POPackageLite extends POPackage {
   ...
   * (non-Javadoc)
   * 
   * @see org.apache.pig.backend.hadoop.executionengine.physicalLayer.
   * relationalOperators.POPackage#setNumInps(int)
   */
  @Override
  ...
  public boolean[] getInner() {
    throw new RuntimeException(
        "POPackageLite does not support getInner operation");
  }

  public void setInner(boolean[] inner) {
    throw new RuntimeException(
        "POPackageLite does not support setInner operation");
  }
  ...
  public boolean isDistinct() {
    throw new RuntimeException(
        "POPackageLite does not support isDistinct operation");
  }
  ...
  public void setDistinct(boolean distinct) {
    throw new RuntimeException(
        "POPackageLite does not support setDistinct operation");
  }
  ...
  /**
   * Similar to POPackage.getNext except that only one input is expected with
   * index 0 and ReadOnceBag is used instead of DefaultDataBag.
   */
  @Override
   ...
   * restore it.
   */
  public Tuple getValueTuple(NullableTuple ntup, int index, Object key)
