...
public class POBinCond extends ExpressionOperator {
  ...
  public Result genericGetNext(byte dataType) throws ExecException {
    ...
    Result result = ((Boolean) res.result) == true ? lhs.getNext(dataType)
        : rhs.getNext(dataType);
  ...
  public Result getNextBoolean() throws ExecException {
    ...
    return ((Boolean) res.result) == true ? lhs.getNextBoolean() : rhs
        .getNextBoolean();
  ...
  @Override
  public String name() {
    return "POBinCond" + "[" + DataType.findTypeName(resultType) + "]" + " - "
        + mKey.toString();
  }
  ...
  public POBinCond clone() throws CloneNotSupportedException {
    POBinCond clone = new POBinCond(new OperatorKey(mKey.scope, NodeIdGenerator
